...
*/	
    ...
    /*
    plan normal_move intention: at_target {
    	do goto target: shared_target on: road_network recompute_path: false;
	}
...
*/
	...
	//evacuazione veloce quando hanno paura confermata allora diventano gialli e quando raggungono il punto di evacuazione "muoiono"
	...
	//questo è quello che viene attivato quando c'è l'intenzione di andare al rifugio
	//finisce quando sono fear comfirmed perche deve andare a fare il piano evacuazione veloce
	//diventano rossi e anche irossi muoiono quando raggiungono il punto di evacuazioen
